...
const Dashboard = () => {
    ...
    return (
        <div className="relative w-full h-screen overflow-hidden text-white font-sans">
            <img className="absolute left-0 top-0 z-0 w-full h-screen object-cover" src="./bg.png" alt="Background Image" />
            <div className="absolute top-0 left-0 z-10 w-full h-screen backdrop-blur-sm bg-black/30">
                ...
                <div className='w-full h-full flex flex-col items-center justify-start pt-20'> 
                    <div className="flex flex-col gap-20 justify-start items-center mt-20 px-4">
                        <h1 className="text-3xl translate-y-10 font-bold mb-6">Welcome back, {userName} ✨</h1>
                        <div className="w-full mb-20 h-80 flex flex-col justify-center items-center bg-black/50 p-6 rounded-xl shadow-[0_0_20px_gold]">
                            <h2 className="text-xl font-semibold mb-4 text-yellow-300">Tarot Module</h2>
                            {selectedCard ? (<p className="text-gray-200"> Your reading: <strong>{selectedCard.name}</strong> - {selectedCard.meaning}</p>) :
                            (<p className="text-gray-400 italic">Click "Draw Cards" to reveal your tarot ✨</p>)}
                        </div>
                        <div className="mt-8 w-200 max-w-4xl grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                            ...
                            <p className="text-sm text-gray-300">Reveal your destiny</p>
                            </div>
